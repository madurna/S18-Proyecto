function reset_seleccion_sorteo(tipo,contenido){
	$.ajax(
		{
		dataType: "html",
		type: "POST",
		...
		url: "reset_seleccion_sorteo.php?tabla=" + tipo,
		...
		complete: function(requestData, exito){
            ...
            $("#contenido p").load("contenido.php?marca="+ now + "&tabla=" + contenido +"&popup=1",function(){
