<?php
	...
	//obtengo el id del Pa&iacute;s a modificar
	...
	//Creo template
	$tpl = new tpl();
	$titulo_grilla = 'Modificar Pa&iacute;s';	
	$error = '';
	//
	
	//verifico que exista el Pa&iacute;s
...
//$frm->addFormRule('encuentraTipoConceptoMod');
	...
	if($frm -> validate()){
		...
		if ($id){	
			...
			$error = 'Error en la modificaci&oacute;n del Pa&iacute;s</b></div>';
	...
	$tpl->assign('secTitulo', WEB_SECCION . ' - Modificar Pa&iacute;s');
