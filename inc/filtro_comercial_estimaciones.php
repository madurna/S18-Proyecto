...
$obj = DB_DataObject::factory('estimaciones');
$periodos = $obj->getPeriodos();
...
//Busco las tarifas
$do = DB_DataObject::factory('tarifa');
$do->find();
$tarifas = array();
$tarifas[0] = "Todas";
while ($do->fetch()) {
    $tarifas[$do->tarifa_id] = $do->tarifa_nombre;
}
...
//$group2[2] =& HTML_QuickForm::createElement('select', 'tarifa_id', 'Tarifas: ');

//$group2[2] =& HTML_QuickForm::createElement('select', 'anio', 'A&ntilde;o: ');
//$group2[2] -> setSelected (date('Y'));
//vector para la carga de los a�os
...
$form->addGroup($group2, 'periodo_anio', 'Mes - A&ntilde;o: ', ' ',false);
$form->addElement('select','tarifa_id','Tarifas:',$tarifas);
