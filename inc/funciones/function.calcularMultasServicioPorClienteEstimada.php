...
function calcularMultasServicioPorClienteEstimada($arch_id = 0, $limite = 0, $semestre_calculado = 25, $cortes = 0, $mdb2 = null) {
    ...
    if (PROCESAR) {
        ...
        if ($res->numRows() > 0) {
            ...
            if ($cortes == 1) {
                ...
                $semestre_calculado = cargarCortesEstimados($sem_id, $tipo_distribuidora_id, $arch_id, $mdb2);
            }
