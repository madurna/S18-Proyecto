...
function calcularMultas($arch_id = 0)
{
    ...
    //
    //    if($arch_lineas_procesadas > 0 && $arch_lineas_procesadas < CANTCLIENTES)
    //        $arch_lineas_procesadas = $row->cantidad + CANTCLIENTES;

    //$lotes = null;
    $cant_lotes_clientes = 0;

    //    if($arch_lineas_procesadas > 0){
    //        for($i= CANTCLIENTES; $i < $arch_lineas_procesadas; ($i = $i+CANTCLIENTES)){
