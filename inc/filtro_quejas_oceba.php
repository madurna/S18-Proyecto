...
$(document).ready(function(){updateSuc();});
</script>');
...
$form->addElement('text','libro','Libro');
$form->addElement('text','folio','Folio');
$form->addElement('text','apellido','Apellido');
$form->addElement('text','dni','DNI');
$form->addElement('text','fechacierre','Fecha de Cierre');
$form->addElement('text','estado','Estado');
