<?php
	...
	//obtengo el id del Provincia a dar de baja
	...
	//Creo template
	$tpl = new tpl();
	$titulo_grilla = 'Eliminar Provincia';	
	$error = '';
	//
	...
	if($frm -> validate()){
		...
		if ($id){	
			...
			$error = 'Error en la eliminaci&oacute;n del Provincia</b></div>';
	...
	$tpl->assign('secTitulo', WEB_SECCION . ' - Eliminar Provincia');
