<?php
   ...
   // print_r($data_empresa);
	...
	$body = "
		...
		<div>
		<div id='container3' style=' float: right; width:100%; height:500px; margin: 0px'></div>
		...
		///Cantidad de empleados por convenio
			$(function () {
			    ...
			    $('#container1').highcharts({
			        ...
			        title: {
			            text: 'Empleados por convenio parcial'
			        },
			        tooltip: {
			    ...
			    $('#container2').highcharts({
			        ...
			        series: [{
			            ...
			            data: [
			                ...
			                ['BELGRANO SUR', 2034],
			                ['MITRE', 3282],
			                ['BELGRANO CARGAS ( T )', 532],
			                ['URQUIZA/SM CARGAS', 2918],
			                ['BELGRANO NORTE ( T )', 365],
			                ['TREN DE LA COSTA', 180],
			                ['SOFSE ENTRE RIOS', 54],
			                ['SOFSE ONCE BRAGADO', 45],
			                ['SARMIENTO', 2918],
			                ['SARMIENTO F. DE CONVENIO', 109],
			                ['FERROCENTRAL', 320],
			                ['EMFER', 419]
			            ]
			        }]
			...
			$(function () {
			    $('#container3').highcharts({
			        ...
			        xAxis: {
			            categories: ['ROCA #7165','SAN MARTIN #2477', 'BELGRANO SUR #2034', 'A.R.H.F. #292', 'MITRE #3282', 'BELGRANO CARGAS ( T ) #532',
			            'URQUIZA/SM CARGAS #2918', 'BELGRANO NORTE ( T ) #365','TREN DE LA COSTA #180', 'SOFSE ENTRE RIOS #54',
			            'SOFSE ONCE BRAGADO #45','SARMIENTO #2918', 'SARMIENTO F. DE CONVENIO #109', 'FERROCENTRAL #320', 'EMFER #419',]
			        },
			        yAxis: {
			            min: 0,
			            title: {
