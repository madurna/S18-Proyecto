<?php
/**
 * Table Definition for localidad_copy1
 */
require_once 'DB/DataObject.php';

class DataObjects_Localidad_copy1 extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'localidad_copy1';     // table name
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_Localidad_copy1',$k,$v); }
