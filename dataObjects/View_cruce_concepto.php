<?php
/**
 * Table Definition for view_cruce_concepto
 */
require_once 'DB/DataObject.php';

class DataObjects_View_cruce_concepto extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'view_cruce_concepto';    // table name
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_View_cruce_concepto',$k,$v); }
