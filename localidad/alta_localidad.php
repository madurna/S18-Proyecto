...
//$frm->addFormRule('encuentraLocalidad');
	//
	...
	if ($frm -> validate()) {
		...
		$do_localidad -> query('BEGIN');
		$id = $do_localidad -> insert(); 
	...
	$tpl->assign('secTitulo', WEB_SECCION . ' - Alta Localidad');
