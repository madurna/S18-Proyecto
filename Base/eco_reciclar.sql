...
-- ----------------------------
DROP TABLE IF EXISTS `pieza_tipo`;
CREATE TABLE `pieza_tipo` (
  `pieza_tipo_id` int(11) NOT NULL AUTO_INCREMENT,
  `pieza_tipo_descripcion` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`pieza_tipo_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `planta` VALUES ('1', 'verde', '2 y 59', '2015-12-16', '2013-02-04', '800000', '1', '303', 'Edificio 2 y 59 - Oficinas');
INSERT INTO `planta` VALUES ('2', 'azul', '2', '2015-04-29', '2015-04-01', '4000000', '1', '307', 'Mejora');
